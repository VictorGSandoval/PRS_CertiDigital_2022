package io.vallegrande.pe.resource;
...
import io.vallegrande.pe.entity.Institute;
import io.vallegrande.pe.repository.InstituteRepository;

@Path("/repository/institutes")
...
public class InstituteResource {
    ...
    private static final Logger LOGGER = Logger.getLogger(InstituteResource.class);
